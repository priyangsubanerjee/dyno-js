        ...
        <div className="flex flex-col lg:flex-row w-full h-full mt-5">
          <div className="flex flex-col w-full lg:w-1/2">
            ...
            <div className="mt-6">
              <img
                src="./icons/code.png"
                className="h-6 lg:h-8 w-6 lg:w-8 inline-block"
                alt=""
              />
              <span className="text-lg lg:text-xl font-bold ml-2 text-gray-700">
                If your are a developer
              </span>
            </div>
            <p className="text-gray-500 text-[14px] leading-6 mt-3 mx-2 lg:mx-8">
            ...
            <ul className="list-disc">
              <li className="text-gray-500 text-[14px] leading-6 mt-3 mx-6 lg:mx-12">
            ...
            <button className="bg-green-500 hover:bg-green-600 text-white h-fit py-3 px-4 rounded-full text-sm mt-10 lg:mt-6">
              Create new
            </button>
          </div>
