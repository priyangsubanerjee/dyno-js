...
function About() {
  return (
    <div>
      <div class="bg-gray-50 rounded-md m-2 lg:m-6 p-4 lg:p-6">
        <div class="flex items-center border-b pb-4">
          <img src="./icons/option.png" class="h-6 w-6" alt="" />
          <h1 class="text-2xl font-semibold text-gray-700 ml-2">About</h1>
        </div>
        <div class="flex flex-col lg:flex-row w-full h-full mt-5">
          <div class="flex flex-col w-full lg:w-1/2">
            <p class="text-gray-600 leading-6 lg:leading-7 text-sm lg:text-base">
            ...
            <div class="flex items-center mt-6">
              <img
                ...
                alt=""
              />
              <h2 class="text-lg lg:text-xl font-bold ml-2 text-gray-700">
                If your are a developer
              </h2>
            </div>
            <p class="text-gray-500 text-[14px] leading-6 mt-3 mx-4 lg:mx-8">
              ...
              <a
                class="text-green-500 font-medium border-b border-green-500"
                href="./documentation"
              >
                View documentation
              </a>
            ...
            <p class="text-gray-500 text-[14px] leading-6 mt-3 mx-4 lg:mx-8">
              ...
              mentioned use cases:
              <ul class="list-disc">
                <li class="text-gray-500 text-[14px] leading-6 mt-3 mx-8 lg:mx-12">
            ...
            <button class="bg-green-500 hover:bg-green-600 text-white h-fit py-3 px-4 rounded-full text-sm mx-8 mt-6">
              Create new
            </button>
          </div>
          <div class="flex justify-center items-center mt-8 lg:mt-0 w-full lg:w-1/2">
            <img
              src="./screenshots/dynoCard.png"
              class="h-full max-h-[500px] hover:scale-105 transition-all cursor-pointer"
              alt=""
            />
          </div>
        </div>
